...
def main():
    ...
    print("Test Files:")
    checks.append(check_file_exists(
        os.path.join(pogs_root, 'examples', 'cpp_cone', 'test_sdp.cpp'),
        "C++ SDP test"
    ))
    checks.append(check_file_exists(
    ...
    checks.append(check_file_exists(
        os.path.join(pogs_root, 'python', 'test_pogs_solver.py'),
        "Python solver tests"
    ))
    checks.append(check_file_exists(
        os.path.join(pogs_root, 'python', 'test_cvxpy_interface.py'),
